...
import data from '../../data/capMap.json'
...
const CapMap = props => {
    ...
    const [query, setQuery] = useState(defaultCapMapQuery)
    const [updatedAt, setUpdatedAt]=useState('')
    const [mapData, setMapData] = useState({})

    // const {status, data, isLoading, isSuccess, error, refetch }  = useTradersQuery({ selectedPage:'fundamentals', endpoint:`graphics/cap-map`, query})
